...
#-------------------------------------ANTÁRTICA
#-----------------------------------------------------------------------------------------------------------------
i1 <- read.table('/home/leticia/Documentos/2020.1/leticia_dados_CMIP/dados_CMIP5/rcp_45/besm_antar_rcp_45.txt')
i2 <- read.table('/home/leticia/Documentos/2020.1/leticia_dados_CMIP/dados_CMIP5/rcp_45/gdfl_antar_rcp_45.txt')
i3 <- read.table('/home/leticia/Documentos/2020.1/leticia_dados_CMIP/dados_CMIP5/rcp_45/mpi_antar_rcp_45.txt')
i4 <- read.table('/home/leticia/Documentos/2020.1/leticia_dados_CMIP/dados_CMIP5/rcp_45/ncar_antar_rcp_45.txt')
#-----
i1 <- i1[-1,]
i2 <- i2[-1,]
i3 <- i3[-1,]
...
#-------------------------------------ARTÍCO
#-----------------------------------------------------------------------------------------------------------------
i1 <- read.table('/home/leticia/Documentos/2020.1/leticia_dados_CMIP/dados_CMIP5/rcp_45/besm_arct_rcp_45.txt')
i2 <- read.table('/home/leticia/Documentos/2020.1/leticia_dados_CMIP/dados_CMIP5/rcp_45/gdfl_arct_rcp_45.txt')
i3 <- read.table('/home/leticia/Documentos/2020.1/leticia_dados_CMIP/dados_CMIP5/rcp_45/mpi_arct_rcp_45.txt')
i4 <- read.table('/home/leticia/Documentos/2020.1/leticia_dados_CMIP/dados_CMIP5/rcp_45/ncar_arct_rcp_45.txt')
#-----
i1 <- i1[-1,]
i2 <- i2[-1,]
i3 <- i3[-1,]
