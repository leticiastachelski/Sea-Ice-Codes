...
#-------------------------------------ANTÁRTICA
#-----------------------------------------------------------------------------------------------------------------
i1 <- read.table("/home/leticia/Documentos/2020.1/leticia_dados_CMIP/dados_CMIP6/ssp_245/fevereiro/GFDL_245.txt") 
i2 <- read.table("/home/leticia/Documentos/2020.1/leticia_dados_CMIP/dados_CMIP6/ssp_245/fevereiro/MPI_245.txt")
i3 <- read.table("/home/leticia/Documentos/2020.1/leticia_dados_CMIP/dados_CMIP6/ssp_245/fevereiro/ncar_245.txt")
#----
i1 <- i1[-1,]
i2 <- i2[-1,]
i3 <- i3[-1,]
...
#------------------------------------- ÁRTICO
#-----------------------------------------------------------------------------------------------------------------
i1 <- read.table("/home/leticia/Documentos/2020.1/leticia_dados_CMIP/dados_CMIP6/ssp_245/GFDL_arct_245.txt", na.strings = '-9.99',) 
i2 <- read.table("/home/leticia/Documentos/2020.1/leticia_dados_CMIP/dados_CMIP6/ssp_245/MPI_arct_245.txt", na.strings = '-9.99')
i3 <- read.table("/home/leticia/Documentos/2020.1/leticia_dados_CMIP/dados_CMIP6/ssp_245/ncar_arct_245.txt", na.strings = '-9.99')
#----
i1 <- i1[-1,]
i2 <- i2[-1,]
i3 <- i3[-1,]
